...
<head>
    ...
    <link rel="stylesheet" href="assets/agendamentocliente.css">
        ...
        <nav class="navbar navbar-dark ">
            <div class="container-fluid">
                <div class="svg-navbar">
                    <svg onclick="window.location.href='/cliente'" xmlns="http://www.w3.org/2000/svg" width="30" height="30"
    ...
    <div class="container">
        <div class="row" id="title-default">
            <div class="col-12 col-sm-12 col-md-12" id="middle_title">
                <H1 id="text">Solicitações Realizadas</H1>
            </div>
        </div>
            ...
            <div class="row mt-5">
                <div class="col-12 col-sm-12 col-md-12" id="middle">
                    <div class="card-default">
                        ...
                        <p class="description">
                            Evento<p class="db-info">{{ $evento->DS_EVENTO }}</p>
                        </p>
                        <p class="description">
                            Nº de Convidados<p class="db-info">{{ $evento->DS_QUANTIDADE_EVENTO }}</p>
                        </p>
                        <p class="description">
                            Endereço<p class="db-info">{{ $evento->NM_ENDERECO_EVENTO }}</p>
                        </p>
                        <p class="description">
                            Data e horário
                            @if ($evento->DT_EVENTO)
                        ...
                        <p class="description">
                            Duração do Evento<p class="db-info">{{ $evento->HR_DURACAO }}
                        </p>
                        <div class="post-info">
                            <div class="btn-card-default">
                                <button class="button-default-pen">{{ $evento->NM_STATUS}}</button>
                            </div>
                        </div>
                    </div>
                </div>
