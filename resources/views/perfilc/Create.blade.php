...
<div class="navbar" id="navbar">
    ...
    <div class="container">
        ...
        <main class="info">
            ...
            <form action="{{ route('perfilc.storec') }}" method="POST">
                @csrf
                    ...
                    <div class="col-12 col-sm-12 col-md-12" id="middle">
                        <div class="card-default">
                            <div class="container_input">
                                ...
                                <div class="inputContainer">
                                    <input required="" class="customInput" type="date" name="DT_NASCIMENTO_CLIENTE">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-12" id="middle">
                        <div class="card-default">
                            <div class="container_input">
                                ...
                                <div class="inputContainer">
                                    <input required="" class="customInput" type="number" name="CD_CPF_CLIENTE">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="a-style">
                    <button id="button" name="submit" type="submit">Incluir Informações</button>
                </div>
                </div>
            </form>
        </main>
