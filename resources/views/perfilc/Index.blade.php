    ...
    <div class="navbar" id="navbar">
        <nav class="navbar navbar-dark ">
            <div class="container-fluid" id="container-fluid">
                <div id="svg-exit">
                    <div class="svg-navbar"><svg onclick="window.location.href='/cliente'" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="#fff" stroke-width="3" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left">
    ...
    <div class="container">
        ...
        <main class="info">
            ...
            <div class=" a-style mt-4">
                <a href="{{ route('perfilc.showc', ['id' => Auth::user()->id]) }}" {{ Auth::user()->info_incluida_cliente ? '' : 'disabled' }}>Ver Perfil Geral</a>
            </div>

            <div class="a-style mt-2">
                <a href="{{ route('perfilc.createc') }}" {{ Auth::user()->info_incluida_cliente ? 'disabled' : '' }}>Incluir Informações</a>
            </div>

            <div class="a-style mt-2">
                <a href="{{ route('perfilc.editc', ['id' => Auth::user()->id]) }}" {{ Auth::user()->info_incluida_cliente ? '' : 'disabled' }}>Atualizar Cadastro</a>
            </div>
        </main>
    </div>
