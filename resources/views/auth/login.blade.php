  ...
  <div class="container">
    ...
    <div class="row mt-3">
      <div class="col-12 col-sm-12 col-md-12" id="card_main">
        ...
        <form class="form_main" method="POST" action="{{ route('login') }}">
          ...
          <div class="inputContainer">
            ...
            <input placeholder="E-mail" id="username" class="inputField" type="email" name="email" :value="old('email')" required autofocus autocomplete="username">
          ...
          <div class="inputContainer">
            ...
            <input placeholder="Password" id="password" class="inputField" type="password" name="password" required autocomplete="current-password">
          ...
          <div class="forgot">
            <div id="form-check">
              ...
              <label class="form-check-label text-white" for="exampleCheck1" name="remember" id="remember_me" type="checkbox">Lembre-me</label>
            </div>
          ...
          <div class="signupContainer">
            ...
            <a href="/cadastro" class="btn-sign">Cadastre-se</a>
          </div>
        </form>
      </div>
    </div>
